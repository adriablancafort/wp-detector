...
const apiRequest = (inputUrl, type) => {
  return fetch(`https://wp-detector.000webhostapp.com/?url=${inputUrl}&type=${type}`)
...
<div class="card card__wp border">
  <img src="/wordpress-detector-success.svg" alt="Success Logo" class="card--icon" width="75" height="60" loading="eager" />
  <div>
...
<div class="card card__wp border">
  <img src="/wordpress-detector-fail.svg" alt="Success Logo" class="card--icon" width="75" height="60" loading="eager" />
  <div>
...
<div class="card card__wp border">
  <img src="/html-retrieve-error.svg" alt="Success Logo" class="card--icon" width="75" height="60" loading="eager" />
  <div>
    <h4 class="card--title cart--title__fail">Bad news...</h4>
